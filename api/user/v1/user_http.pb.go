...
const OperationUserCreateUser = "/v1.User/CreateUser"
const OperationUserDeleteUser = "/v1.User/DeleteUser"
const OperationUserGetUser = "/v1.User/GetUser"
const OperationUserListUser = "/v1.User/ListUser"
const OperationUserUpdateUser = "/v1.User/UpdateUser"
...
func RegisterUserHTTPServer(s *http.Server, srv UserHTTPServer) {
	r := s.Route("/")
	r.POST("/user/v1/created", _User_CreateUser0_HTTP_Handler(srv))
	r.PUT("/user/v1/update", _User_UpdateUser0_HTTP_Handler(srv))
	r.DELETE("/user/v1/{id}", _User_DeleteUser0_HTTP_Handler(srv))
	r.GET("/user/v1/{id}", _User_GetUser0_HTTP_Handler(srv))
...
type UserHTTPClient interface {
	CreateUser(ctx context.Context, req *CreateUserRequest, opts ...http.CallOption) (rsp *UserInfo, err error)
...
func (c *UserHTTPClientImpl) CreateUser(ctx context.Context, in *CreateUserRequest, opts ...http.CallOption) (*UserInfo, error) {
	var out UserInfo
	pattern := "/user/v1/created"
