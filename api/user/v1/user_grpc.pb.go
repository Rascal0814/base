...
type UserClient interface {
	...
	GetUserByPhone(ctx context.Context, in *GetUserByPhoneRequest, opts ...grpc.CallOption) (*UserInfo, error)
	ListUser(ctx context.Context, in *ListUserRequest, opts ...grpc.CallOption) (*ListUserReply, error)
	VerifyPassword(ctx context.Context, in *VerifPasswordRequest, opts ...grpc.CallOption) (*VerifPasswordReply, error)
}
...
func (c *userClient) GetUserByPhone(ctx context.Context, in *GetUserByPhoneRequest, opts ...grpc.CallOption) (*UserInfo, error) {
	out := new(UserInfo)
	err := c.cc.Invoke(ctx, "/v1.User/GetUserByPhone", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *userClient) VerifyPassword(ctx context.Context, in *VerifPasswordRequest, opts ...grpc.CallOption) (*VerifPasswordReply, error) {
	out := new(VerifPasswordReply)
	err := c.cc.Invoke(ctx, "/v1.User/VerifyPassword", in, out, opts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
type UserServer interface {
	...
	GetUserByPhone(context.Context, *GetUserByPhoneRequest) (*UserInfo, error)
	ListUser(context.Context, *ListUserRequest) (*ListUserReply, error)
	VerifyPassword(context.Context, *VerifPasswordRequest) (*VerifPasswordReply, error)
...
func (UnimplementedUserServer) GetUserByPhone(context.Context, *GetUserByPhoneRequest) (*UserInfo, error) {
...
func (UnimplementedUserServer) VerifyPassword(context.Context, *VerifPasswordRequest) (*VerifPasswordReply, error) {
...
func _User_GetUserByPhone_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.User/GetUserByPhone",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
...
func _User_VerifyPassword_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: "/v1.User/VerifyPassword",
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(UserServer).VerifyPassword(ctx, req.(*VerifPasswordRequest))
	}
	return interceptor(ctx, in, info, handler)
}
